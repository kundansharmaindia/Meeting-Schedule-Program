...
@WebServlet("/BookingInfoByUser")
public class BookingInfoByUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       System.out.print("use wise info"+user);
        MeetingRoomBooking room=new MeetingRoomBooking();
        try {
            JSONArray jr = room.getBookingInfoDateWiseWithUser(stTs, endTs,user);
